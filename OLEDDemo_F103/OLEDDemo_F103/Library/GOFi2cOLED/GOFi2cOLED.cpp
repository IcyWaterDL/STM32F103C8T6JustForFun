...
#include "Core.h"  // for: delay()
#include "Wire.h"
#include "GOFi2cOLED.h"

// a 5x7 font table
//const unsigned char  BasicFont[] PROGMEM = {
const uint8_t BasicFont[] = {
...
void GOFi2cOLED::drawBitmap(uint8_t x, uint8_t y, const uint8_t *bitmap, uint8_t w, uint8_t h, uint8_t color) {
